...
public class ProfiledConnection extends ConnectionAdapter {
    ...
    private static Hashtable<String,ProfiledConnectionEntry> insertQueries = new Hashtable<String,ProfiledConnectionEntry>();
    private static Hashtable<String,ProfiledConnectionEntry> updateQueries = new Hashtable<String,ProfiledConnectionEntry>();
    private static Hashtable<String,ProfiledConnectionEntry> selectQueries = new Hashtable<String,ProfiledConnectionEntry>();
    private static Hashtable<String,ProfiledConnectionEntry> deleteQueries = new Hashtable<String,ProfiledConnectionEntry>();
